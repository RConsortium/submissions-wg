...
## Attendees not in current data file
...
* Nan Xiao has created a Pyton version of `{pkglite}` which is now part of the Pharmaverse! Details on the package can be found on GitHub at <https://github.com/pharmaverse/py-pkglite?
* The group discussed the possibilities of Pytthon being part of future submission using multiple languages? Time will tell, but there could be a future Pilot that addresses the possibilitiy.
