...
* Lovemore and Sam shared the group's recent updates progress. They recently invited Christine Christine Rossin (from the Phuse ADRG working group) to their meetings for discussion on the proposed template.
...
* The metadata group will be taking the lead on autoring guidelines for the R exection and environment language
* The group will also establish diaglogs with other sub-teams addressing additional sections of ADRG such as such as estimands team to ensure everyone is on the same page for updating the ADRG sections
...
- Robert shared that CDISC will hold a general meeting on February 18, 2025. Members of the working group are encouraged to attend.
