...
* [rig](https://github.com/r-lib/rig): The R Installation Manager (cross-platform)
* R Consortium blog post: [The Crucial Role of Release Control in R for Healthcare Organizations](https://r-consortium.org/posts/the-crucial-role-of-release-control-in-r-for-healthcare-organizations/)
* [Developers, Reinvented](https://ashtom.github.io/developers-reinvented) (Thomas Dohmke)
* R/Pharma GenAI Day 2025 recordings [playlist](https://www.youtube.com/playlist?list=PLMtxz1fUYA5CrQehBULN5lHlnz-uVLOxy)
