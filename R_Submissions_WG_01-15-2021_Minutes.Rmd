...
Joseph Rickert began the meeting by noting that he Submisisons working group now has a [GithHub Repo](https://github.com/RConsortium/rtrs-wg/pulls) which contains the minutes and video recording from the first meeting. 
